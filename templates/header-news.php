...
<header id="header" class="w-full">
	<div class="container_max flex py-[3.4rem] justify-between">
		<a href="/" class="header_logo w-[160px] ">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/black_logo.svg" alt="">
		</a>
		<nav class="flex justify-start items-center w-[48%]">
			<ul class="flex min-w-[670px]">
				<li class="pr-[2.8rem]">
					<a href="/concept" class="text-black">CONCEPT</a>
				</li>
				<li class="pr-[2.8rem]">
					<a href="/concept#four_features" class="text-black ">FOUR FEATURES</a>
				</li>
				<li class="pr-[2.8rem]">
					<a href="/#salons" class="text-black ">SALONS</a>
				</li>
				<li class="pr-[2.8rem]">
					<a href="/menu" class="text-black ">MENU</a>
				</li>
				<li class="pr-[2.8rem]">
					<a href="/news" class="text-black ">NEWS</a>
				</li>
				<li class="pr-[2.8rem]">
					<a href="/gallery" class="text-black ">GALLERY</a>
				</li>
				<li class="pr-[2.8rem]">
					<a href="/recruit" target="_blank" class="text-black ">RECRUIT</a>
				</li>
				<li class="pr-[2.8rem]">
					<a href="/about" class="text-black ">COMPANY</a>
				</li>
				<li class="pr-[2.8rem]">
			...
			<div class="flex">
				<div class="left">
					...
					<div class="reserve pc" class="pt-9 pb-15">
						...
						<p class="text-center mb-1.5">お電話より<br>ご予約を承っております。</p>

							<a href="tel:0566552647" class="button mb-1 mx-auto block text-2.5">0566-55-2647</a>
							<p class="text-center text-2 mb-3">電話受付. 10:00 - 19:00. （月曜日を除く）</p>
