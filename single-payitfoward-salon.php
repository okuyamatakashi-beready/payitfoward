...
?>
<div class="salon__mv bg <?php echo esc_attr( $slug ); ?>" style="background-image: url('<?php echo esc_url($mv_image); ?>');">
    <div class="container mx-auto">
        <div class="salon__mv--upper flex">
            ...
            <div class="salon__mv--right">
                <?php if (have_rows('salon_img')) : the_row(); ?>
            ...
            <div class="<?php echo $use_swiper ? 'swiper-wrapper' : 'thumbs-wrapper'; ?>">
                ...
                ?>
                    <div class="<?php echo $use_swiper ? 'swiper-slide' : 'thumb-slide'; ?>">
                        <div class="thumb <?php echo $count === 0 ? 'active' : ''; ?>"
            ...
            <div class="concept__right">
                ...
                <?php if ($concept_img): ?>
                    <div class="concept__image--wrapper">
                        <div class="concept__image" style="background-image: url('<?php echo esc_url($concept_img); ?>');"></div>
                        <div class="concept__image--gray" style="background-image: url('<?php echo esc_url($concept_img); ?>');"></div>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<div class="salon__staff <?php echo esc_attr( $slug ); ?>">
    <div class="container mx-auto">
        ...
        <div class="staff__list flex">
            ...
            ?>
                    <div class="staff__card">
                        <div class="staff__img" style="background-image: url('<?php echo esc_url($staff_img); ?>');">

                        </div>
                        <div class="staff__meta">
                            <p class="staff__position"><?php echo esc_html($position); ?></p>
                            <p class="staff__name-en"><?php echo esc_html($name_en); ?></p>
                            <p class="staff__name-jp"><?php echo esc_html($name_jp); ?></p>
                        </div>

                        <?php if ($instagram) : ?>
                            <a class="staff__insta" href="<?php echo esc_url($instagram); ?>" target="_blank" rel="noopener">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/salon/staff-insta-icon.svg" alt="Instagram">
                            </a>
                        <?php endif; ?>
                    </div>
            <?php
        ...
        <?php $thumbnail_url = get_the_post_thumbnail_url(get_the_ID(), 'full'); ?>
            ...
            <div class="infomation__content mx-auto">
                ...
                <dl class="infomation__detail">
                    ...
                    <dd>
                        <a href="<?php echo esc_url($map_link); ?>" target="_blank" rel="noopener noreferrer" class="flex">
                        [ Google Map <span class="map-icon"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/salon/map-icon.svg" alt="" /></span>]
                        </a>
                    </dd>
                </dl>
                ...
                <div class="infomation__icons">
                    <a href="<?php echo esc_url(get_field('instagram')); ?>" target="_blank" rel="noopener">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/salon/insta-icon.svg" alt="Instagram">
                    </a>
                    <a href="<?php echo esc_url(get_field('hotpepper')); ?>" target="_blank" rel="noopener">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/salon/hotpepper-icon.svg" alt="Hotpepper">
                    </a>
                </div>
            </div>
        </div>
